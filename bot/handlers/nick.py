...
После подтверждения:
  ...
  • Для администраторов (Лидер/Дитя клана/Старейшина) автоматически
...
◇ Участник бот не может автоматически изменить имя в чате.
"""
import logging
...
async def cb_how_to_rename(callback: CallbackQuery) -> None:
    ...
    await callback.message.answer(
        ...
        "<b>Для администраторов клана</b> (Лидер / Дитя клана / Старейшина):\n"
