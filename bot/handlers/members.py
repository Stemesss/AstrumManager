...
async def cb_mem_season_ok(
    ...
    report = (
        f"🏆 <b>Новый сезон успешно начат!</b>\n\n"
        f"{_DIVIDER}\n\n"
        f"👥 <b>Участников:</b> {result['users_count']}\n"
        f"📊 <b>Очки активности обнулены</b>\n"
        f"📝 <b>Журнал активности очищен</b> ({result['logs_deleted']} записей)\n"
        f"✅ <b>Игровые ники сохранены</b>\n"
        f"🔒 <b>Роли и права сохранены</b>\n\n"
        f"{_DIVIDER}\n\n"
