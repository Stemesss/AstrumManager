...
_DEFAULT_RULES_CONTENT = (
    "🤝 1. Уважайте всех участников клана.\n\n"
    "💬 2. Будьте активны в жизни клана.\n\n"
    "🎮 3. Игровой ник в AstrumManager должен совпадать с ником в игре.\n\n"
    "🔒 4. Передача аккаунта третьим лицам запрещена.\n\n"
    "🚫 5. Спам, реклама и сторонние ссылки запрещены.\n\n"
    "⚖️ 6. Спорные ситуации решаются администрацией.\n\n"
    "📅 7. Отсутствие более 14 дней без предупреждения может привести к исключению.\n\n"
    "👑 8. Решения Лидера, Дитя клана и Старейшин обязательны к исполнению."
)
